...
// Manejando un State con ref
  ...
  } Se sustituye con v-model */ 

// <! -------------------------->

 // Manejando un State con reactive
...
<template>
  <div class="my-20 max-w-lg mx-auto bg-white shadow p-10">
    ...
    <div class="my-5">
      ...
      <h2 class="text-2xl font-extrabold text-gray-5-- text-center"> 
    ...
    <div v-if="total > 0" class="my-10 space-y-3 bg-gray-50 p-5">
      <h2 class="text-2xl font-extrabold text-gray-500 text-center">
        Resumen <span class="text-indigo-600">de pagos</span>
      </h2>

      <p class="text-xl text-gray-500 text-center font-bold"> {{meses}} Meses </p>
      <p class="text-xl text-gray-500 text-center font-bold"> Total pagar:{{ formatearDinero( total ) }} </p>
